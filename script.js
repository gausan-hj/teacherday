...
const teachers = [
    ...
    { name: "Teacher Vatsala", color: "#000000", question: "How many letters are there in the English alphabet?", options: ["A. 24", "B. 25", "C. 26", "D. 27"], answer: "C", url: "teacher/teacher-vatsala.html", lang: "english", subject: "English", icon: "📖" },
    ...
    { name: "Teacher Pavithra", color: "#009688", question: "What is the past tense of 'write'?", options: ["A. writed", "B. wrote", "C. written", "D. writing"], answer: "B", url: "teacher/teacher-pavithra.html", lang: "english", subject: "English", icon: "✍️" },
    ...
    { name: "Teacher Subatra", color: "#F44336", question: "What is the past tense of 'go'?", options: ["A. goed", "B. gone", "C. went", "D. going"], answer: "C", url: "teacher/teacher-subatra.html", lang: "english", subject: "English", icon: "🗣️" },
    ...
    // ===== New Teachers =====
    { name: "Teacher Pei Yi", color: "#2196F3", question: "What is the present tense of 'went'?", options: ["A. Go", "B. Goes", "C. Going", "D. Gone"], answer: "A", url: "teacher/teacher-pei-yi.html", lang: "english", subject: "English", icon: "📘" },
...
function getGuessQuestionsForTeacher(teacher) {
    const allQuestions = [
        ...
        { q: "Does the teacher have 'Ms.' in their name?", fn: t => t.name.startsWith('Ms.') || t.name === 'Teacher Pei Yi' },
